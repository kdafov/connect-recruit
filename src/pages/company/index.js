...
import PersonalNav from '@/components/Nav/Custom';
import RecruiterPage from '@/components/Recruiter/Default';
...
export default function User() {
    ...
    useEffect(() => {
        ...
        axios.post('/api/checkPrivilege', {
            ...
            if (response.data.action === 'valid') {
                ...
                //Gather user name & id from the JWT token
    ...
    return (
        <>
            <Head>
            <title>Connect - Recruiter home page</title>
            ...
            <PersonalNav type={'company'} notifications={[false]}/>
            <RecruiterPage />
        </>
    )
}
